...
export const workflows: Workflow[] = [
    ...
    "steps": [
      {
        ...
        "description": "Branch off main for each new feature"
      },
      {
        "phase": "Develop",
        "action": "Make small, focused commits",
        "command": "git commit -m \"feat: add new feature\"",
        "description": "Commit early and often"
      },
      {
        "phase": "Sync",
        "action": "Rebase on latest main",
        "command": "git fetch && git rebase origin/main",
        "description": "Keep your branch up to date"
      },
      {
        "phase": "Review",
        "action": "Self-review changes",
      ...
      },
      {
        ...
        "command": "git checkout main && git merge feat/my-feature",
        "description": "Merge with a merge commit"
      },
      {
        "phase": "Release",
        "action": "Tag the release",
        "command": "git tag -a v1.0.0 -m \"Release v1.0.0\"",
        "description": "Create a semantic version tag"
      },
      {
        "phase": "Push",
        "action": "Push everything",
        "command": "git push origin main --tags",
        "description": "Push branch and tags to remote"
      },
      {
        "phase": "Cleanup",
        "action": "Delete feature branch",
        "command": "git branch -d feat/my-feature",
  ...
  },
  {
    ...
    "steps": [
      {
        "phase": "Plan",
        "action": "Create issue and assign",
        "command": "",
        "description": "Track work in GitHub Issues"
      },
      {
        "phase": "Branch",
        "action": "Create feature branch from main",
        "command": "git checkout -b feat/issue-123-feature",
        "description": "Use issue numbers in branch names"
      },
      {
        "phase": "Develop",
        "action": "Make conventional commits",
      ...
      },
      {
        ...
        "command": "git push -u origin feat/issue-123-feature",
        "description": "Share your branch"
      },
      {
        "phase": "PR",
      ...
      },
      {
        ...
        "command": "",
        "description": "Use squash merge for clean history"
      },
      {
        "phase": "Deploy",
        "action": "Deploy to staging",
        "command": "",
        "description": "Auto-deploy main to staging"
      }
    ],
    "commands": [
  ...
  },
  {
    ...
    "description": "Comprehensive workflow for enterprise teams",
    "type": "Enterprise",
    "branchStrategy": "Git Flow with develop, release, and hotfix branches",
    "releaseStrategy": "Scheduled releases with semantic versioning",
    "steps": [
      {
        "phase": "Develop",
        "action": "Feature branches from develop",
        "command": "git checkout -b feature/feat-name develop",
        "description": "Branch from develop for features"
      },
      {
        "phase": "PR to Develop",
        "action": "Merge feature to develop",
        "command": "",
        "description": "PR must pass CI and get approvals"
      },
      {
        "phase": "Release Prep",
        "action": "Create release branch",
        "command": "git checkout -b release/1.2.0 develop",
        "description": "Branch from develop for release"
      },
      {
        "phase": "Stabilize",
        "action": "Fix bugs on release branch",
        "command": "",
        "description": "Only bug fixes on release branch"
      },
      {
        "phase": "Release",
        "action": "Merge to main and tag",
        "command": "git checkout main && git merge release/1.2.0 && git tag -a v1.2.0 -m \"v1.2.0\"",
        "description": "Merge to main and tag"
      },
      {
        "phase": "Back Merge",
        "action": "Merge back to develop",
        "command": "git checkout develop && git merge main",
        "description": "Keep develop in sync"
      },
      {
        "phase": "Hotfix",
        "action": "Emergency fix from main",
        "command": "git checkout -b hotfix/1.2.1 main",
        "description": "Branch from main for hotfixes"
      }
    ],
    "commands": [
  ...
  },
  {
    ...
    "steps": [
      {
        "phase": "Fork",
        "action": "Fork the repository on GitHub",
        "command": "",
        "description": "Create a fork under your account"
      },
      {
        "phase": "Clone",
        "action": "Clone your fork locally",
        "command": "git clone https://github.com/your-username/repo.git",
      ...
      },
      {
        ...
        "description": "Track original repository"
      },
      {
        "phase": "Branch",
        "action": "Create feature branch",
        "command": "git checkout -b feat/improvement",
        "description": "Branch from main"
      },
      {
        "phase": "Sync",
        "action": "Keep fork updated",
        "command": "git fetch upstream && git rebase upstream/main",
        "description": "Stay up to date"
      },
      {
        "phase": "Push",
        "action": "Push to your fork",
        "command": "git push -u origin feat/improvement",
      ...
      },
      {
        ...
        "command": "",
        "description": "Update branch based on review"
      }
    ],
    "commands": [
  ...
  },
  {
    ...
    "description": "Fast-paced workflow for startups",
    "type": "Startup",
    "branchStrategy": "Short-lived feature branches with continuous deployment",
    "releaseStrategy": "Continuous deployment with feature flags",
    "steps": [
      {
        "phase": "Ideate",
        "action": "Create experiment branch",
        "command": "git checkout -b experiment/feature-idea",
        "description": "Quickly prototype ideas"
      },
      {
        "phase": "Build",
        "action": "MVP implementation",
        "command": "git commit -m \"feat: implement MVP\"",
      ...
      },
      {
        ...
        "command": "",
        "description": "Check metrics and feedback"
      },
      {
        "phase": "Iterate",
        "action": "Improve based on feedback",
        "command": "",
        "description": "Quick iteration cycles"
      }
    ],
    "commands": [
